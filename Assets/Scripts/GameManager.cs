...
public class GameManager : NetworkBehaviour
{
    ...
    {
        Horizontal, Vertical, DiagonalA, DiagonalB
    }
    ...
    {
        //Debug.Log("TestWinnerLine: "
        //    + line.gridVector2IntList[0].x + ", " + line.gridVector2IntList[0].y
        //    + "|| " + line.gridVector2IntList[1].x + ", " + line.gridVector2IntList[1].y
        //    + "|| " + line.gridVector2IntList[2].x + ", " + line.gridVector2IntList[2].y);
